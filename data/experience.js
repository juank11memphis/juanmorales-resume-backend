  ...
  data: [
    {
      ...
      country: 'Costa Rica',
      responsabilities: [
        'Being employee number one, allowed me to help to grow the company up to 40+ employees',
    ...
    },
    {
      ...
      country: 'Costa Rica',
      responsabilities: [
        'Self marketing is one of my biggest roles right now',
